...
using System.Text;
using WebApplication1.Models.Xero;  // Import from the main project
using WebApplication1.Models;  // Import ChartOfAccount model from the main project
using WebApplication1.Data;  // Import DbContext from the main project
